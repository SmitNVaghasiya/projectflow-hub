<!-- -- Disable activity and achivements for now and after completing the Main Features.
-- Reason for commenting the Download button is will enable when main task will be completed. Done -- 18/03/2026-->

-- I have added kanban in the main site but i should have added it for the project/id page as in this page we should show them also show them as kanban is mainly be going to be used for the tasks rather than managing the project ??.




-------------------------------------------LATER-------------------------------------------------
-- I can add things like timeline so that can track the project task when happening -- Later.
